...
public class BookSpecifications {
    ...
    public static Specification<Book> publishYearGreaterOrEqualsThan(int sincePublishYear) {
        return (Specification<Book>) (root, criteriaQuery, criteriaBuilder) -> criteriaBuilder.greaterThanOrEqualTo(root.get("publishYear"), sincePublishYear);
    }
